...
--
-- Host: 127.0.0.1
-- Czas generowania: 01 Paź 2019, 20:48
...
(6, 'Ross', 'Kenneth', 'Matematyka dyskretna', 79.98, 2012, 'Matematyka', ''),
(7, 'Wojciech', 'Kordecki', 'Matematyka dyskretna dla informatyków', 59.99, 2018, 'Matematyka', ''),
(8, 'Joanna', 'Piasecka', 'Algebra liniowa z elementami geometrii', 19.99, 2019, 'Matematyka', ''),
(9, 'Witold', 'Kołodziej', 'Analiza matematyczna', 39.99, 2009, 'Matematyka', ''),
(10, 'Ian', 'Stewart', 'Podstawy matematyki', 89.99, 2009, 'Matematyka', ''),
(11, 'Gavin', 'Hesketh', 'Cząstki elementarne', 89.99, 2017, 'Fizyka', ''),
(12, 'Józef', 'Spałek', 'Wstęp do fizyki materii skondensowanej', 29.99, 2017, 'Fizyka', ''),
(13, 'Danuta ', 'Adamska-Rutkowska', 'Kwantowa rzeczywistość', 49.99, 2019, 'Fizyka', ''),
(14, 'Hobson', 'Art', 'Kwanty dla każdego. Jak zrozumieć to, czego nikt nie rozumie', 39.99, 2018, 'Fizyka', ''),
(15, 'Deruelle', 'Nathalie', 'Fale grawitacyjne. Nowa era astrofizyki ', 9.99, 2019, 'Fizyka', ''),
(16, 'Marek', 'Blicharski', 'Inżynieria materiałowa', 9.99, 2017, 'Inzynieria', ''),
(17, 'Gibilisco', 'Stan', 'Schematy elektroniczne i elektryczne. Przewodnik dla początkujących', 39.99, 2014, 'Inzynieria', ''),
(18, 'Dariusz', 'Butrymowicz ', 'Chłodnictwo i klimatyzacja', 29.99, 2016, 'Inzynieria', ''),
(19, 'Zenon', 'Wiłun', 'Zarys geotechniki', 59.99, 2013, 'Inzynieria', '');
