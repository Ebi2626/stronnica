...
?>
    <div class="profile">
        ...
        <div class="profile__item">
            <p class="profile__label">Obecny avatar:</p><img id="userAvatar" src="<?php ?>" class="profile__img" alt="avatar">
        </div>
        <div class="profile__item">
            <p class="profile__label" id="userMail">Obecny adres e-mail:</p><p class="profile__result"><?php ?></p>
        </div>
        <div class="profile__item">
            <p class="profile__label" id="userCity">Obecne miasto:</p><p class="profile__result"><?php ?></p>
        </div>
        <div class="profile__item">
            <p class="profile__label" id="userAdress">Obecny adres:</p><p class="profile__result"><?php ?></p>
        </div>
    </div>
</div>
<main class="changing">
    <h2 class="changing__title">Ustawienia</h2>
    <form class="changing__item" method="post" action="changeAvatar.php">
        <div class="changing__line">
            <label for="avatar" class="changing__label--title">Zmień swój avatar:</label>
            <input type="file" name="avatar" id="avatar" class="changing__input" accept="image/*" />
            <input type="submit" class="changing__submit"  value="Zmień"/>
        </div>
    </form>
    <form class="changing__item" method="post" action="changeEmail.php">
        <div class="changing__line">
            <label for="email" class="changing__label--title">Zmień swój adres e-mail:</label>
            <input type="email" name="email" id="email" class="changing__input" />
            <input type="submit" class="changing__submit"  value="Zmień"/>
        </div>
    </form>
    <form class="changing__item" method="post" action="changeAdress.php">
        <p class="changing__label--title">Zmień swój adres</p>
        <div class="changing__line">
            <label for="city" class="changing__label">Wprowadź nowe miasto:</label>
            <input type="text" name="city" id="city" class="changing__input" />
        </div>
        <div class="changing__line">
            <label for="adress" class="changing__label">Wprowadź nowy adres:</label>
            <input type="text" name="adress" id="adress" class="changing__input" />
            <input type="submit" class="changing__submit"  value="Zmień"/>
        </div>
    </form>
    <form class="changing__item" method="post" action="changePassword.php">
        ...
        <div class="changing__line">
            ...
            <input type="password" name="oldPassword" id="oldPassword" class="changing__input" />
        </div>
        <div class="changing__line">
            <label for="newPassword" class="changing__label">Wprowadź nowe hasło:</label>
            <input type="password" name="newPassword" id="newPassword" class="changing__input" />
            <input type="submit" class="changing__submit"  value="Zmień"/>
        </div>
    </form>
    <form class="changing__item" method="post" action="removeAccount.php">
        ...
        <div class="changing__line">
            ...
            <input type="password" name="password" id="password" class="changing__input" />
